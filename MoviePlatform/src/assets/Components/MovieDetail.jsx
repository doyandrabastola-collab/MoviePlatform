...
export function MovieDetails() {
    ...
    useEffect(() => {
        async function fetchMovieDetails() {
            // Validate id: guard against literal ':id' or non-numeric values
            ...
            try {
                ...
                setError(err.response?.status === 404 ? 'Movie not found (404)' : err.message)
            } finally {
                setIsLoading(false)
            }
        }
    ...
    if (error) return (
        <div className="p-6 text-center text-white">
            ...
            <p className="text-sm text-gray-300">Please check the movie link or go back to the homepage.</p>
        </div>
    )
    ...
    return (
        <div className="w-full h-full overflow-y-auto relative flex justify-center border">
            ...
            <div className="relative   z-10 container mx-auto px-6 py-24 min-h-fit  flex flex-col md:flex-row gap-12 items-center md:items-start">
