    ...
    return (
      <div className="p-6 text-center text-white">
        ...
        <p className="text-sm text-gray-300">
          Please check the movie link or go back to the homepage.
        </p>
      </div>
    )
  }
        ...
        <div className="flex-1 text-white pt-4 md:pt-12">
          ...
          <div className="flex flex-wrap gap-2 mb-8">
            {movie.genres?.map((genre) => (
              <span
                key={genre.id}
                className="px-4 py-1.5 text-sm bg-purple-500/20 text-purple-300 rounded-full border border-purple-500/30 backdrop-blur-sm"
              >
                {genre.name}
              </span>
            ))}
