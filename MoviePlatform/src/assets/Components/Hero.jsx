  ...
  return (
    <div className="relative h-[77vh] w-full bg-black flex items-center overflow-hidden">
      ...
      <div className="w-full inset-0">
        ...
        {/* Gradients */}
        <div className="absolute inset-0 bg-linear-to-r from-black/90 via-black/40 to-transparent border-2 border-white" />
      ...
      <div className="absolute z-10 px-12 max-w-2xl">
        ...
        <div className="flex items-center space-x-4">
          ...
          <button
            className="flex items-center justify-center border-2 border-gray-400 rounded-full w-12 h-12 text-gray-300 hover:text-white hover:border-white transition-colors"
          >
            <svg
